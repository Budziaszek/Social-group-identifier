...
# from essential_generators import DocumentGenerator # TODO where is this DocumentGenerator?
...
class UserAgent(Agent):
    ...
    def write_post(self):
        ...
        new_post = Post(attitude=['?'], author=self,
                        ...
                        text="no text because no generator")  # TODO: Random tags, what about attidute?
